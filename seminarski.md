...
- [2. Teorijski okvir](#2-teorijski-okvir)
  - [2.1. Osnovni termini i oblast u kojoj se praksa radi](#21-osnovni-termini-i-oblast-u-kojoj-se-praksa-radi)
    ...
    - [2.1.3. Cloud computing - računarstvo u oblaku  //TODO](#213-cloud-computing---računarstvo-u-oblaku--todo)
  - [2.2. Organizacija rada](#22-organizacija-rada)
    - [2.2.1. Struktura ljudi](#221-struktura-ljudi)
    - [2.2.2. Sastanci - tehnički deo](#222-sastanci---tehnički-deo)
    - [2.2.3. Sastanci - netehnički deo](#223-sastanci---netehnički-deo)
  - [2.3. Ključni korišćeni alati](#23-ključni-korišćeni-alati)
    - [2.3.1. Arduino ekosistem](#231-arduino-ekosistem)
    - [2.3.2. Qt Framework //TODO](#232-qt-framework-todo)
- [3. Sadržaj projekta //TODO](#3-sadržaj-projekta-todo)
  - [3.1. Šira slika projekta //TODO](#31-šira-slika-projekta-todo)
    - [3.1.1. Primer primene, davanje konteksta //TODO](#311-primer-primene-davanje-konteksta-todo)
    - [3.1.2. Korišćeni alati (upitno da li treba uz ključne) //TODO](#312-korišćeni-alati-upitno-da-li-treba-uz-ključne-todo)
  - [3.2. Struktura projekta - hardware](#32-struktura-projekta---hardware)
    ...
    - [3.2.2. Raspberry Pi kao posrednik //TODO](#322-raspberry-pi-kao-posrednik-todo)
    - [3.2.3. "Hardver" cloud platforme? //TODO](#323-hardver-cloud-platforme-todo)
    - [3.2.4. Hardver krajnjeg korisnika //TODO](#324-hardver-krajnjeg-korisnika-todo)
  - [3.3. Struktura projekta - sofware //TODO](#33-struktura-projekta---sofware-todo)
    - [3.3.1. Arduino firmware](#331-arduino-firmware)
    - [3.3.2. Raspberry Pi Cloud Client //TODO](#332-raspberry-pi-cloud-client-todo)
    - [3.3.3. WolkAbout Cloud platforma //TODO](#333-wolkabout-cloud-platforma-todo)
    - [3.3.4. PC (ili Android) Data Visualizer //TODO](#334-pc-ili-android-data-visualizer-todo)
- [4. Zaključak //TODO](#4-zaključak-todo)
